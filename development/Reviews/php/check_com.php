<?php
	...
	if(isset($_POST['new_comment'])) {
		...
		if(isset($new_com_text)) {
			mysqli_query($connect, "INSERT INTO `parents` (`username`, `text`, `date`, `code`) VALUES ('$new_com_name', '$new_com_text', '$new_com_date', '$new_com_code')");
		}
		header("Location: ");
	}
	// new reply
	if(isset($_POST['new_reply'])) {
		...
		if(isset($new_reply_text)) {
			mysqli_query($connect, "INSERT INTO `children` (`username`, `text`, `date`, `par_code`) VALUES ('$new_reply_name', '$new_reply_text', '$new_reply_date', '$new_reply_code')") or die(mysqli_error($connect));
		}
		header("Location: ");
	}
?>